...
namespace LMSProject.Areas.Admin.Controllers
{
    ...
    public class SchedulesController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? gradeId, int? termId, int? instructorId)
        {
            ...
            return View("~/Areas/Admin/Views/Schedules/Index.cshtml", await query.ToListAsync());
        }
        ...
        public async Task<IActionResult> GradeSchedule(int gradeId, int? termId)
        {
            ...
            return View("~/Areas/Admin/Views/Schedules/GradeSchedule.cshtml", sessions);
        }
        ...
        public async Task<IActionResult> Manage(int courseId)
        {
            ...
            return View("~/Areas/Admin/Views/Schedules/Manage.cshtml", course);
        }
